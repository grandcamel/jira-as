"""
Test utilities for JIRA integration tests.

Provides reusable utilities for testing against JIRA instances:
...
def get_jira_version(client: "JiraClient") -> tuple[int, int, int]:
    """
...
def is_cloud_instance(client: "JiraClient") -> bool:
    """
